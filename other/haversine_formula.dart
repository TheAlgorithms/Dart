...
double haversine(fi) => pow(sin(fi / 2), 2) as double;
...
void main() {
  Coordinates newYork = Coordinates(40.730610, -73.935242);
  Coordinates moskov = Coordinates(55.751244, 37.618423);
  Coordinates toronto = Coordinates(43.651070, -79.347015);
  Coordinates seoul = Coordinates(37.532600, 127.024612);
