...
String decimal_to_any(int value, int base) {
  var ALPHABET_VALUES = { 10: 'A', 11: 'B', 12: 'C', 13: 'D', 14: 'E', 15: 'F',
  ...
  if (value == 0)
	...
	if (base < 2 || base > 36)
		throw FormatException("Base not supported!");
  ...
  while (value > 0) {
    ...
    value  = value ~/ base;
    output = (remainder < 10 ? remainder.toString() : ALPHABET_VALUES[remainder]) + output;
  }
